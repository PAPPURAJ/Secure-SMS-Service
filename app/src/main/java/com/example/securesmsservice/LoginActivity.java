...
public class LoginActivity extends AppCompatActivity {
    ...
    public  void loginClick(View view){
        String userName=((EditText)findViewById(R.id.loginUsernameEt)).getText().toString();
        String pass=((EditText)findViewById(R.id.loginUserpassEt)).getText().toString();

        if(userName.equals("") || pass.equals("") || !sp.getString("name","-1").equals(userName) || !sp.getString("pass",pass).equals("-1")){
